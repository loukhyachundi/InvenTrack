...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Welcome to Inventory Management System. Please Login here!");
        ...
        jPanel4.setBackground(new java.awt.Color(251, 237, 220));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ims/Images/img13.png"))); // NOI18N
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(Lid)
                                    .addComponent(Lpass, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "SELECT Id,Password,Usertype FROM emp_ims WHERE ID ='"+Lid.getText()+"'";
        ...
        try {
            ...
            if(rs.next() == true) {
                ...
                if(Lid.getText().equals(rs.getString(1))) {
                    if(Lpass.getText().equals(rs.getString(2))) {
                        ...
                        if (rs.getString(3).equals(x)) {
                            ...
                            AdminDashboard db1 = new AdminDashboard();
                            db1.show();
                            dispose();
                            break;
                        }
                            ...
                            loginid = rs.getString(1);
                            EmployeeDashboard db2 = new EmployeeDashboard();
                            db2.show();
                            dispose();
                            break;
                        }
                ...
                javax.swing.JOptionPane.showMessageDialog(null, "Please enter correct unique id");
            }
